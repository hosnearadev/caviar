  ...
  return (
    <>
      <div className="py-10 bg-[url('../../../src/assets/image/caviar.jpg.jpg')]">
        <div className="flex flex-shrink py-24">
          <h1 className="ms-48 text-7xl text-white font-bold inline bg-gray-800 pb-3">Wir sind gerne für Sie da...</h1>
        </div>
      </div>
        ...
        <div className="container mx-auto px-5 md:px-[100px]">
          <div className="">
            <div className="flex flex-col md:flex-row gap-10 justify-center">
              <div className="ps-14 bg-white pt-10  -mt-10 rounded-2xl pr-[60px]">
